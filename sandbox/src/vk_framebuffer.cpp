...
namespace vk
{
    namespace framebuffer
    {
        ...
        uint32_t framebuffer::add_attachment(attachment_create_info& create_info)
        {
            ...
            FA.description.stencilLoadOp = VK_ATTACHMENT_LOAD_OP_DONT_CARE;
        ...
        void framebuffer::create_sampler(const VkFilter mag_filter, const VkFilter min_filter, VkSamplerAddressMode address_mode)
        {
        ...
        void framebuffer::create_renderpass()
        {
            ...
            auto RP = info::renderpass_create_info2();
            ...
            OP_SUCCESS(vkCreateRenderPass2(gpu->device, &RP, gpu->allocation_callbacks, &renderpass));
